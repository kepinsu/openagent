...
|------|------|-------------|--------|-------|
| Root navigation | .opencode/context/navigation.md | context-manager | Active | Entry point for contextscout |
| Core discovery | .opencode/context/core/discovery/ | contextscout | Active | Job and handoff contract |
| Context system | .opencode/context/core/context-system/ | context-manager | Active | Catalog and maintenance rules |
| Task management | .opencode/context/core/task-management/ | task-manager | Active | Task lifecycle and JSON schema |
| Project intelligence | .opencode/context/project-intelligence/ | DocWriter / context-manager | Active | Delivery facts / structural navigation |
